const AUTH0_CLIENT_ID = "6Tm5cTFRNWmY3pvUCG52u4H1ebvfEroy";
const AUTH0_DOMAIN = "mkhalegaonkar3.auth0.com";
const AUTH0_CALLBACK_URL = location.href;
const AUTH0_API_AUDIENCE = "https://localhost:3005/joke/";
...
constructor(props){
    ...
    serverRequest(){
        $.get("http://localhost:3005/api/jokes", res => {
        this.setState({
            jokes: res
        });
        });
...
class Joke extends React.Component{
    constructor(props){
        ...
        serverRequest(joke){
            $.post(
                "http://localhost:3005/api/jokes/like/" + joke.id,
                { like: 1 },
                res => {
                  console.log("res... ", res);
